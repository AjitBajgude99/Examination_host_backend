...
public String toString() {
	return "Test [id=" + id + ", name=" + name + ", start=" + start + ", end=" + end + ", questionCount="
			+ questionCount + ", passingCount=" + passingCount + ", result=" + result + ", getId()=" + getId()
			+ ", getName()=" + getName() + ", getStart()=" + getStart() + ", getEnd()=" + getEnd()
			+ ", getQuestionCount()=" + getQuestionCount() + ", getPassingCount()=" + getPassingCount()
